...
- Operator Console wireframe: `docs/architecture/ELM369_OPERATOR_CONSOLE_WIREFRAME_v0.1.0.md`
- Visual system v0.1: `docs/architecture/ELM369_VISUAL_SYSTEM_v0.1.0.md`
