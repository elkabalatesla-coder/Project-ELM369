...
Updated: 2026-09-07 · Operator Spine v0.1 (docs)
...
## Operator Spine (v0.1 design)

Phase-1 ops facade is **specified** in `docs/architecture/ELM369_OPERATOR_SPINE_v0.1.0.md`.
Entrypoint code (`tools/elm_operator`) ships in a follow-on PR after AUDIO-TX clears.
...
- `docs/architecture/ELM369_OPERATOR_SPINE_v0.1.0.md` — Spine design
